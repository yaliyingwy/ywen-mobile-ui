...
exports.default = _react2.default.createClass({
  ...
  _computeStyle: function _computeStyle() {
    ...
    if (progress < 25) {
      ...
      var _angle = -90 + (progress - 25) / 100 * 360;
      style.s0_25.transform = 'rotate(0deg)';
      style.s25_50.transform = 'rotate(' + _angle + 'deg)';
    } else if (progress >= 50 && progress < 75) {
      var _angle2 = -90 + (progress - 50) / 100 * 360;
      style.s0_25.transform = 'rotate(0deg)';
      style.s25_50.transform = 'rotate(0deg)';
      style.s50_75.transform = 'rotate(' + _angle2 + 'deg)';
    } else if (progress >= 75 && progress <= 100) {
      var _angle3 = -90 + (progress - 75) / 100 * 360;
      style.s0_25.transform = 'rotate(0deg)';
      style.s25_50.transform = 'rotate(0deg)';
      style.s50_75.transform = 'rotate(0deg)';
      style.s75_100.transform = 'rotate(' + _angle3 + 'deg)';
    }
    return style;
  },
