...
exports.default = _react2.default.createClass({
  ...
  _selectItem: function _selectItem(_ref) {
    ...
    if (group === 0) {
      var year = (0, _parseInt2.default)(years[index], 10);
      if (selectYear !== year) {
        ...
        if (months.length !== newMonths.length) {
          var minMonth = (0, _parseInt2.default)(newMonths[0], 10);
          var maxMonth = (0, _parseInt2.default)(newMonths[newMonths.length - 1], 10);
          state.selectMonth = (0, _util.valueBetween)({
            max: maxMonth,
            min: minMonth,
            value: selectMonth
          });
        ...
        if (days.length !== newDays.length) {
          var minDay = (0, _parseInt2.default)(newDays[0], 10);
          var maxDay = (0, _parseInt2.default)(newDays[newDays.length - 1], 10);
          state.selectDay = (0, _util.valueBetween)({
            max: maxDay,
            min: minDay,
            value: selectDay
          });
      ...
      var month = (0, _parseInt2.default)(months[index], 10);
      ...
      this.setState({
        days: _newDays,
        selectMonth: month,
        selectDay: (0, _parseInt2.default)(_newDays[0], 10)
      });
    } else if (group === 2) {
      var day = (0, _parseInt2.default)(days[index], 10);
      this.setState({
        selectDay: day
      });
    }
