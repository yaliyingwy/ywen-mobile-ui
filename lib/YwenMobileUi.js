...
exports.DatePicker = exports.Picker = exports.Raty = exports.ImageUploader = exports.Scroller = exports.Carousel = exports.Progress = exports.LazyLoad = exports.ListView = exports.Image = exports.Toast = exports.Confirm = exports.Overlay = exports.dismiss = exports.showLoading = exports.showToast = exports.showConfirm = exports.showOverlay = undefined;
...
var RC_OVERLAY = (0, _symbol2.default)('Overlay');
var RC_CONFIRM = (0, _symbol2.default)('Confirm');
var RC_TOAST = (0, _symbol2.default)('Toast');
var RC_LOADING = (0, _symbol2.default)('Loading');
var RC_NONE = (0, _symbol2.default)('None');
...
var Modal = _react2.default.createClass({
  ...
  render: function render() {
    ...
    switch (type) {
      case RC_OVERLAY:
        modal = _react2.default.createElement(_Overlay2.default, (0, _extends3.default)({ show: show }, props));
        break;
      case RC_CONFIRM:
        var confirmCb = props.confirmCb;
        var cancelCb = props.cancelCb;
        var reset = (0, _objectWithoutProperties3.default)(props, ['confirmCb', 'cancelCb']);
        ...
        modal = _react2.default.createElement(_Confirm2.default, (0, _extends3.default)({ confirmCb: newConfirmCb, cancelCb: newCancelCb, show: show }, reset));
        break;
      case RC_TOAST:
        modal = _react2.default.createElement(_Toast2.default, (0, _extends3.default)({ show: show }, props));
        break;
      case RC_LOADING:
        modal = _react2.default.createElement(_Loading2.default, (0, _extends3.default)({ show: show }, props));
        break;
      default:
