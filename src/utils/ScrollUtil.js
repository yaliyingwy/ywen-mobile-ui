...
//       scrollingComplete: () => console.log('scroll complete'),
...
//       self.__isAnimating = core.effect.Animate.start(step, verify, completed, self.options.animationDuration, wasAnimating ? this.easeOutCubic : this.
//         easeInOutCubic);
//     } else {
